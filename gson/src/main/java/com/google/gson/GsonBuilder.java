...
import static com.google.gson.Gson.DEFAULT_FLATTENING;
...
public final class GsonBuilder {
  ...
  // !! Added
  private boolean enableFlattening = DEFAULT_FLATTENING;
  ...
  GsonBuilder(Gson gson) {
    ...
    // !! Modified
    this.enableFlattening = gson.enableFlattening;
  }

  // !! Modified function for enableFlattening
  @CanIgnoreReturnValue
  public GsonBuilder enableFlattening() {
    this.enableFlattening = true;
    return this;
  }
