...
import com.google.gson.internal.bind.FlatteningTypeAdapterFactory;
...
public final class Gson {
  ...
  // !! Modified
  static final boolean DEFAULT_FLATTENING = false;
  ...
  // !! Modified
  final boolean enableFlattening;
  ...
  Gson(
    ...
    // !! Modified
    if (enableFlattening) {
      factories.add(new FlatteningTypeAdapterFactory());
    }
